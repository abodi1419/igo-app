...
@section('title',__('Restaurant create products category'))
@section('title_bar')
    <div style="margin-right: 60px">
        <div class="row">
            <h6 class="col-8"><a class="text-dark" href="{{route('admin.restaurant.index')}}">{{__("Restaurants")}}</a> /
                ...
                {{__("Restaurant create products category")}}
            </h6>
...
@section('content')
    ...
    <div class="container">
        <div class="card border-dark">
            <div class="card-header text-bg-dark fw-bold">{{ __('Create category') }}</div>

            <div class="card-body">
                <form action="{{route('admin.restaurant.categories.store',$restaurant)}}" method="post">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="index" type="number" step="1" class="form-control @error('index') is-invalid @enderror" name="index" value="{{ old('index') }}" required autofocus>
