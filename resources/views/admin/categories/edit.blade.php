...
@section('title',__('Restaurant edit products category'))
@section('title_bar')
    <div style="margin-right: 60px">
        <div class="row">
            <h6 class="col-8"><a class="text-dark" href="{{route('admin.restaurant.index')}}">{{__("Restaurants")}}</a> /
                ...
                {{__("Restaurant edit products category")}}
            </h6>
...
@section('content')
    ...
    <div class="container">
        <div class="card border-dark">
            <div class="card-header text-bg-dark fw-bold">{{ __('Edit category') }}</div>

            <div class="card-body">
                <form action="{{route('admin.restaurant.categories.update',[$productsCategory,$restaurant])}}" method="post">
                    @csrf
                    @method('PATCH')
