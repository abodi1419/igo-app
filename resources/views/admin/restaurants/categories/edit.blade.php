...
@section('title',__('Edit restaurants category'))
@section('title_bar')
...
@section('content')
    <div class="container">
        <div class="card border-dark">
            <div class="card-header text-bg-dark">{{ __('Edit restaurants category') }}</div>
            ...
            <div class="card-body">
                <form action="{{route('admin.categories.update',$category->id)}}" method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <textarea name="description_ar" class="form-control @error('description_ar') is-invalid @enderror" id="description_ar" cols="30" rows="10">{{ $category->description_ar }}</textarea>
