...
@section('title',__('Restaurant create coupon'))
@section('title_bar')
...
@section('content')
    ...
    <div class="container">
        <div class="card border-dark">
            <div class="card-header text-bg-dark fw-bold">{{ __('Create coupon') }}</div>

            <div class="card-body">
                <form action="{{route('admin.restaurant.coupons.store',$restaurant)}}" method="post">
