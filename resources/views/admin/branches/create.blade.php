...
@section('title',__('Restaurant create branch'))
@section('title_bar')
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card border-dark">
                    <div class="card-header fw-bold text-bg-dark">{{ __('Create branch') }}</div>

                    <div class="card-body">
                        <form action="{{route('admin.restaurant.branches.store',$restaurant)}}" method="post">
                            @csrf
