            ...
            <div class="card-body">
                ...
                <div class="text-center mt-3">
                    ...
                    <div id="rm-{{$product->id}}" @if(!$isInCategory) style="display: none" @endif >
                        <button class="btn btn-danger" onclick="removeProduct('{{asset('restaurant/categories/remove/product'.'/'.$productsCategory->id.'/'.$product->id)}}')">
                            <i class="fa fa-minus fa-lg"></i>
                        </button>
                    </div>

                    <div id="add-{{$product->id}}" @if($isInCategory) style="display: none" @endif >
                        <button class="btn btn-success" onclick="addProduct('{{asset('restaurant/categories/add/product'.'/'.$productsCategory->id.'/'.$product->id)}}')">
