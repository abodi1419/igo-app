    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card border-success">
                <div class="card-header text-bg-success fw-bold">{{ __('Register') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('customer.register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" placeholder="{{__('Enter name')}}" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
