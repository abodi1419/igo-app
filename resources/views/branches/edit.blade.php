        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card border-success">
                    <div class="card-header text-bg-success fw-bold">{{ __('Edit branch') }}</div>
                    ...
                    <div class="card-body">
                        <form action="{{route('branches.update',$branch)}}" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name_ar" placeholder="فرع المروة" type="text" class="form-control @error('name_ar') is-invalid @enderror" name="name_ar" value="{{ $branch->name_ar }}" required autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="street_ar" type="text" placeholder="شارع حراء" class="form-control @error('street_ar') is-invalid @enderror" value="{{$branch->street_ar}}" name="street_ar" required>
