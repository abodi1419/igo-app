            ...
            <div class="card-body">
                ...
                <div class="text-center mt-3">
                    ...
                    <div id="rm-{{$product->id}}" @if(!$isInMenu) style="display: none" @endif >
                        <button class="btn btn-danger" onclick="removeProduct('{{asset('restaurant/menus/remove/product'.'/'.$menu->id.'/'.$product->id)}}')">
                            <i class="fa fa-minus fa-lg"></i>
                        </button>
                    </div>

                    <div id="add-{{$product->id}}" @if($isInMenu) style="display: none" @endif >
                        <button class="btn btn-success" onclick="addProduct('{{asset('restaurant/menus/add/product'.'/'.$menu->id.'/'.$product->id)}}')">
